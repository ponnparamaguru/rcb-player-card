    ...
    <div className='w-full h-screen md:w-full md:h-screen bg-yellow-400'>
      <div className='md:hidden'>
          <div className='pt-10 pl-5'>
              <div className='text-red-600 text-4xl font-black uppercase'>{props.name.split(' ')[0]}</div>
              <div className='text-black text-5xl font-black uppercase'>{props.name.split(' ')[1]}</div>
            </div>
        ...
        <div className='pl-5 pt-5 pr-5 pb-5'>
          <h1 className=' text-xs text-justify text-black '>{props.description}</h1>
          <div className='flex pt-10 text-4xl gap-5'>
